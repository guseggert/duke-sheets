//! End-to-end tests for password-protected XLSX (OOXML Agile).
//!
//! Fixture `agile_aes256.xlsx` is generated by
//! `mise run crypto:fixtures` (which calls LibreOffice's `storeToURL`
//! with EncryptionData NamedValue magic). It's an Agile-encrypted
//! `.xlsx`: AES-256-CBC, SHA-512 KDF, default Office spinCount=100000.
//!
//! Cells: A1 = "hello crypto", B1 = 42.0.
