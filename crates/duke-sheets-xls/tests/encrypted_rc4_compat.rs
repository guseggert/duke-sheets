...
//! path. Each test reads the gitignored
//! `xls_rc4_cryptoapi.plain.xls` fixture's `/Workbook` stream, encrypts
//! it with one of our three FilePass variants, wraps the result in a
//! fresh CFB envelope, writes the file into the URP-shared directory,
//! and asks LibreOffice to open it with the password and read back
...
#[test]
#[ignore = "requires LibreOffice URP on 127.0.0.1:2002 + crypto fixture"]
