...
fn bessel_y0(x: f64) -> f64 {
    ...
    if x < 8.0 {
        ...
        (std::f64::consts::FRAC_2_PI / x).sqrt() * (xx.sin() * p0 + z * xx.cos() * q0)
    }
}
    ...
    if x < 8.0 {
        ...
        let ans1 = x
            * (-4.900604943e12
                + y * (1.27527439e12
                    + y * (-5.153438139e10
                        + y * (7.349264551e8 + y * (-4.237922726e6 + y * 8511.937935)))));
        let ans2 = 2.49958057e13
            + y * (4.244419664e11
                + y * (3.733650367e9
                    + y * (2.245904002e7 + y * (1.02042605e5 + y * (354.9632885 + y)))));
        ...
        (std::f64::consts::FRAC_2_PI / x).sqrt() * (xx.sin() * p1 + z * xx.cos() * q1)
    }
}
