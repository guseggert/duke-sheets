...
//! ```
//!
//! The protocol is a generic COM proxy with a small set of commands: `Ping`,
//! `Init`, `Get`, `Set`, `Invoke`, `Navigate`, `Release`, and `Shutdown`.
//! All Excel-specific knowledge lives in this client crate.
//!
//! # Example
//!
//! ```rust,no_run
