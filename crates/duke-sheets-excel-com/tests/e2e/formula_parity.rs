...
fn populate_data_sheet(wb: &Workbook<'_>) -> Result<(), BridgeError> {
    ...
    let trend_y_values = [2.1, 4.0, 5.8, 8.1, 10.2, 11.9, 14.1, 15.8, 18.0, 20.1];
    for (offset, y) in trend_y_values.iter().enumerate() {
        let row = 280 + offset as u32;
        wb.set_cell_value(&cell_addr(row, 1), (offset + 1) as f64)?;
        wb.set_cell_value(&cell_addr(row, 2), *y)?;
    }
    ...
    for (offset, (x, y)) in paired_values.iter().enumerate() {
        let row = 292 + offset as u32;
        wb.set_cell_value(&cell_addr(row, 1), *x)?;
        wb.set_cell_value(&cell_addr(row, 2), *y)?;
    }

    wb.set_cell_value("A298", "3+4i")?;
    wb.set_cell_value("B298", "1-2i")?;
    wb.set_cell_value("C298", "5i")?;

    let prob_values = [(0.0, 0.1), (1.0, 0.2), (2.0, 0.3), (3.0, 0.25), (4.0, 0.15)];
    for (offset, (x, p)) in prob_values.iter().enumerate() {
        let row = 300 + offset as u32;
        wb.set_cell_value(&cell_addr(row, 1), *x)?;
...
fn populate_tests_sheet(wb: &mut Workbook<'_>) -> Result<(), BridgeError> {
    ...
    assert!(
        cases.len() >= 1000,
        "expected at least 1000 parity cases, got {}",
        cases.len()
    );
...
fn additional_function_cases() -> Vec<FormulaCase> {
    vec![
        case(
            "ALIAS_BETADIST_basic",
            "BETADIST(0.5,2,3)",
            "=BETADIST(0.5,2,3)",
            "number",
        ),
        ...
        case(
            "ALIAS_CRITBINOM_basic",
            "CRITBINOM(10,0.5,0.05)",
            "=CRITBINOM(10,0.5,0.05)",
            "number",
        ),
        case(
            "ALIAS_EXPONDIST_basic",
            "EXPONDIST(1,1,TRUE)",
            "=EXPONDIST(1,1,TRUE)",
            "number",
        ),
        ...
        case(
            "ALIAS_FTEST_basic",
            "FTEST(Data!A292:A296,Data!B292:B296)",
            "=FTEST(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
            "ALIAS_GAMMADIST_basic",
            "GAMMADIST(2,2,1,TRUE)",
            "=GAMMADIST(2,2,1,TRUE)",
            "number",
        ),
        case(
            "ALIAS_GAMMAINV_basic",
            "GAMMAINV(0.5,2,1)",
            "=GAMMAINV(0.5,2,1)",
            "number",
        ),
        case(
            "ALIAS_HYPGEOMDIST_basic",
            "HYPGEOMDIST(1,4,3,10)",
            "=HYPGEOMDIST(1,4,3,10)",
            "number",
        ),
        case(
        ...
        case(
            "ALIAS_LOGNORMDIST_basic",
            "LOGNORMDIST(1,0,1)",
            "=LOGNORMDIST(1,0,1)",
            "number",
        ),
        case(
            "ALIAS_NEGBINOMDIST_basic",
            "NEGBINOMDIST(3,5,0.5)",
            "=NEGBINOMDIST(3,5,0.5)",
            "number",
        ),
        case(
            "ALIAS_NORMDIST_basic",
            "NORMDIST(0,0,1,TRUE)",
            "=NORMDIST(0,0,1,TRUE)",
            "number",
        ),
        case(
            "ALIAS_NORMSDIST_zero",
            "NORMSDIST(0)",
            "=NORMSDIST(0)",
            "number",
        ),
        ...
        case(
            "ALIAS_TTEST_basic",
            "TTEST(Data!A292:A296,Data!B292:B296,2,1)",
            "=TTEST(Data!A292:A296,Data!B292:B296,2,1)",
            "number",
        ),
        case(
        ...
        case(
            "ALIAS_ZTEST_basic",
            "ZTEST(Data!A100:A109,25)",
            "=ZTEST(Data!A100:A109,25)",
            "number",
        ),
        case(
            "STAT_BINOM_DIST_RANGE",
        ...
        case(
            "STAT_CHISQ_TEST",
            "CHISQ.TEST(Data!A292:A296,Data!B292:B296)",
            "=CHISQ.TEST(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
        ...
        case(
            "STAT_COVARIANCE_P",
            "COVARIANCE.P(Data!A292:A296,Data!B292:B296)",
            "=COVARIANCE.P(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
            "STAT_COVARIANCE_S",
            "COVARIANCE.S(Data!A292:A296,Data!B292:B296)",
            "=COVARIANCE.S(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
        ...
        case(
            "STAT_F_TEST",
            "F.TEST(Data!A292:A296,Data!B292:B296)",
            "=F.TEST(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
        ...
        case2(
            "STAT_MODE_MULT_first",
            "INDEX(MODE.MULT(Data!S1:S12),1,1)",
            "=INDEX(MODE.MULT(Data!S1:S12),1,1)",
            "number",
        ),
        case(
            "STAT_PERCENTRANK_EXC",
            "PERCENTRANK.EXC(Data!A100:A109,25)",
            "=PERCENTRANK.EXC(Data!A100:A109,25)",
            "number",
        ),
        case(
            "STAT_QUARTILE_EXC",
            "QUARTILE.EXC(Data!A100:A109,2)",
            "=QUARTILE.EXC(Data!A100:A109,2)",
            "number",
        ),
        case(
            "STAT_SKEW_P",
            "SKEW.P(Data!A100:A109)",
            "=SKEW.P(Data!A100:A109)",
            "number",
        ),
        case(
            "STAT_PROB_basic",
            "PROB(Data!A300:A304,Data!B300:B304,1,3)",
            "=PROB(Data!A300:A304,Data!B300:B304,1,3)",
            "number",
        ),
        case(
            "STAT_COVAR_alias",
            "COVAR(Data!A292:A296,Data!B292:B296)",
            "=COVAR(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
            "STAT_CONFIDENCE_alias",
        ...
        case(
            "STAT_PEARSON_basic",
            "PEARSON(Data!A292:A296,Data!B292:B296)",
            "=PEARSON(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
            "STAT_RSQ_basic",
            "RSQ(Data!A292:A296,Data!B292:B296)",
            "=RSQ(Data!A292:A296,Data!B292:B296)",
            "number",
        ),
        case(
            "STAT_STEYX_basic",
            "STEYX(Data!B292:B296,Data!A292:A296)",
            "=STEYX(Data!B292:B296,Data!A292:A296)",
            "number",
        ),
        case(
            "STAT_STDEVA_mixed",
            "STDEVA(Data!A50,Data!A52,Data!A51)",
            "=STDEVA(Data!A50,Data!A52,Data!A51)",
            "number",
        ),
        case(
            "STAT_STDEVP_alias",
            "STDEVP(Data!A100:A109)",
            "=STDEVP(Data!A100:A109)",
            "number",
        ),
        case(
            "STAT_STDEVPA_mixed",
            "STDEVPA(Data!A50,Data!A52,Data!A51)",
            "=STDEVPA(Data!A50,Data!A52,Data!A51)",
            "number",
        ),
        case(
            "STAT_VARA_mixed",
            "VARA(Data!A50,Data!A52,Data!A51)",
            "=VARA(Data!A50,Data!A52,Data!A51)",
            "number",
        ),
        case(
        ...
        case(
            "STAT_VARPA_mixed",
            "VARPA(Data!A50,Data!A52,Data!A51)",
            "=VARPA(Data!A50,Data!A52,Data!A51)",
            "number",
        ),
        case(
            "STAT_PERCENTRANK_alias",
            "PERCENTRANK(Data!A100:A109,25)",
            "=PERCENTRANK(Data!A100:A109,25)",
            "number",
        ),
        case(
            "STAT_PERCENTOF_basic",
            "PERCENTOF(Data!A100:A104,Data!A100:A109)",
            "=PERCENTOF(Data!A100:A104,Data!A100:A109)",
            "number",
        ),
        case(
        ...
        case(
            "STAT_T_TEST_basic",
            "T.TEST(Data!A292:A296,Data!B292:B296,2,1)",
            "=T.TEST(Data!A292:A296,Data!B292:B296,2,1)",
            "number",
        ),
        case(
            "STAT_FORECAST_LINEAR",
            "FORECAST.LINEAR(11,Data!B280:B289,Data!A280:A289)",
            "=FORECAST.LINEAR(11,Data!B280:B289,Data!A280:A289)",
            "number",
        ),
        case(
            "STAT_FORECAST_ETS",
            "FORECAST.ETS(11,Data!B280:B289,Data!A280:A289)",
            "=FORECAST.ETS(11,Data!B280:B289,Data!A280:A289)",
            "number",
        ),
        case2(
            "STAT_GROWTH_first",
            "INDEX(GROWTH({2,4,8},{1,2,3},{4}),1,1)",
            "=INDEX(GROWTH({2,4,8},{1,2,3},{4}),1,1)",
            "number",
        ),
        case2(
            "STAT_TREND_first",
            "INDEX(TREND(Data!B280:B289,Data!A280:A289,{11}),1,1)",
            "=INDEX(TREND(Data!B280:B289,Data!A280:A289,{11}),1,1)",
            "number",
        ),
        case(
        ...
        case(
            "ENG_IMARGUMENT_basic",
            "IMARGUMENT(Data!A298)",
            "=IMARGUMENT(Data!A298)",
            "number",
        ),
        case(
            "ENG_IMCONJUGATE_basic",
            "IMCONJUGATE(Data!A298)",
            "=IMCONJUGATE(Data!A298)",
            "string",
        ),
        case(
        ...
        case(
            "ENG_ERF_PRECISE_basic",
            "ERF.PRECISE(1)",
            "=ERF.PRECISE(1)",
            "number",
        ),
        case(
            "ENG_ERFC_PRECISE_basic",
            "ERFC.PRECISE(1)",
            "=ERFC.PRECISE(1)",
            "number",
        ),
        case(
            "FIN_ACCRINT_basic",
            "ACCRINT(Data!A234,Data!A234+180,Data!A234+90,Data!B233,1000,2,0,1)",
            "=ACCRINT(Data!A234,Data!A234+180,Data!A234+90,Data!B233,1000,2,0,1)",
            "number",
        ),
        case(
            "FIN_DISC_basic",
            "DISC(Data!A234,Data!A234+180,99,100,0)",
            "=DISC(Data!A234,Data!A234+180,99,100,0)",
            "number",
        ),
        case(
            "FIN_INTRATE_basic",
            "INTRATE(Data!A234,Data!A234+180,990,1000,0)",
            "=INTRATE(Data!A234,Data!A234+180,990,1000,0)",
            "number",
        ),
        case(
            "FIN_MDURATION_basic",
            "MDURATION(Data!A234+30,Data!B234,Data!B233,Data!C233,2,0)",
            "=MDURATION(Data!A234+30,Data!B234,Data!B233,Data!C233,2,0)",
            "number",
        ),
        case(
            "FIN_RECEIVED_basic",
            "RECEIVED(Data!A234,Data!A234+180,1000,0.05,0)",
            "=RECEIVED(Data!A234,Data!A234+180,1000,0.05,0)",
            "number",
        ),
        case(
            "FIN_PRICE_basic",
            "PRICE(Data!A234+30,Data!B234,Data!B233,Data!C233,100,2,0)",
            "=PRICE(Data!A234+30,Data!B234,Data!B233,Data!C233,100,2,0)",
            "number",
        ),
        case(
            "FIN_PRICEDISC_basic",
            "PRICEDISC(Data!A234,Data!A234+180,0.05,100,0)",
            "=PRICEDISC(Data!A234,Data!A234+180,0.05,100,0)",
            "number",
        ),
        case(
            "FIN_PRICEMAT_basic",
            "PRICEMAT(Data!A234+30,Data!B234,Data!A234,0.05,0.04,0)",
            "=PRICEMAT(Data!A234+30,Data!B234,Data!A234,0.05,0.04,0)",
            "number",
        ),
        case(
            "FIN_TBILLEQ_basic",
            "TBILLEQ(Data!A234,Data!A234+180,0.05)",
            "=TBILLEQ(Data!A234,Data!A234+180,0.05)",
            "number",
        ),
        case(
            "FIN_TBILLPRICE_basic",
            "TBILLPRICE(Data!A234,Data!A234+180,0.05)",
            "=TBILLPRICE(Data!A234,Data!A234+180,0.05)",
            "number",
        ),
        case(
            "FIN_TBILLYIELD_basic",
            "TBILLYIELD(Data!A234,Data!A234+180,99)",
            "=TBILLYIELD(Data!A234,Data!A234+180,99)",
            "number",
        ),
        case(
            "FIN_YIELD_basic",
            "YIELD(Data!A234+30,Data!B234,Data!B233,99,100,2,0)",
            "=YIELD(Data!A234+30,Data!B234,Data!B233,99,100,2,0)",
            "number",
        ),
        case(
            "FIN_YIELDDISC_basic",
            "YIELDDISC(Data!A234,Data!A234+180,99,100,0)",
            "=YIELDDISC(Data!A234,Data!A234+180,99,100,0)",
            "number",
        ),
        case(
            "FIN_YIELDMAT_basic",
            "YIELDMAT(Data!A234+30,Data!B234,Data!A234,0.05,99,0)",
            "=YIELDMAT(Data!A234+30,Data!B234,Data!A234,0.05,99,0)",
            "number",
        ),
        case(
            "FIN_VDB_basic",
            "VDB(10000,1000,10,0,1)",
            "=VDB(10000,1000,10,0,1)",
            "number",
        ),
        case(
            "FIN_AMORDEGRC_basic",
            "AMORDEGRC(10000,Data!A234,Data!A234+180,1000,1,0.15,0)",
            "=AMORDEGRC(10000,Data!A234,Data!A234+180,1000,1,0.15,0)",
            "number",
        ),
        case(
            "FIN_AMORLINC_basic",
            "AMORLINC(10000,Data!A234,Data!A234+180,1000,1,0.15,0)",
            "=AMORLINC(10000,Data!A234,Data!A234+180,1000,1,0.15,0)",
            "number",
        ),
        case(
            "FIN_COUPDAYBS_basic",
            "COUPDAYBS(Data!A234+30,Data!B234,2,0)",
            "=COUPDAYBS(Data!A234+30,Data!B234,2,0)",
            "number",
        ),
        case(
            "FIN_COUPDAYS_basic",
            "COUPDAYS(Data!A234+30,Data!B234,2,0)",
            "=COUPDAYS(Data!A234+30,Data!B234,2,0)",
            "number",
        ),
        case(
            "FIN_COUPDAYSNC_basic",
            "COUPDAYSNC(Data!A234+30,Data!B234,2,0)",
            "=COUPDAYSNC(Data!A234+30,Data!B234,2,0)",
            "number",
        ),
        case(
            "FIN_COUPNCD_basic",
            "COUPNCD(Data!A234+30,Data!B234,2,0)",
            "=COUPNCD(Data!A234+30,Data!B234,2,0)",
            "number",
        ),
        case(
            "FIN_COUPNUM_basic",
            "COUPNUM(Data!A234+30,Data!B234,2,0)",
            "=COUPNUM(Data!A234+30,Data!B234,2,0)",
            "number",
        ),
        case(
            "FIN_COUPPCD_basic",
            "COUPPCD(Data!A234+30,Data!B234,2,0)",
            "=COUPPCD(Data!A234+30,Data!B234,2,0)",
            "number",
        ),
        case(
        ...
        case(
            "MATH_CEILING_MATH_basic",
            "CEILING.MATH(2.3,1)",
            "=CEILING.MATH(2.3,1)",
            "number",
        ),
        case(
            "MATH_CEILING_PRECISE_basic",
            "CEILING.PRECISE(2.3,1)",
            "=CEILING.PRECISE(2.3,1)",
            "number",
        ),
        case(
        ...
        case(
            "MATH_FLOOR_PRECISE_basic",
            "FLOOR.PRECISE(-2.7,1)",
            "=FLOOR.PRECISE(-2.7,1)",
            "number",
        ),
        case(
            "MATH_ISO_CEILING_basic",
            "ISO.CEILING(2.3,1)",
            "=ISO.CEILING(2.3,1)",
            "number",
        ),
        case(
            "MATH_MDETERM_basic",
            "MDETERM(Data!A275:C277)",
            "=MDETERM(Data!A275:C277)",
            "number",
        ),
        case(
            "MATH_PERMUTATIONA_basic",
            "PERMUTATIONA(10,3)",
            "=PERMUTATIONA(10,3)",
            "number",
        ),
        ...
        case(
            "INFO_WORKDAY_INTL_basic",
            "WORKDAY.INTL(Data!A112,10,1)",
            "=WORKDAY.INTL(Data!A112,10,1)",
            "number",
        ),
        case(
            "DB_DCOUNTA_basic",
            "DCOUNTA(Data!A150:D160,\"Name\",Data!A162:B163)",
            "=DCOUNTA(Data!A150:D160,\"Name\",Data!A162:B163)",
            "number",
        ),
        case(
            "DB_DPRODUCT_basic",
            "DPRODUCT(Data!A150:D160,3,Data!A162:B163)",
            "=DPRODUCT(Data!A150:D160,3,Data!A162:B163)",
            "number",
        ),
        case(
            "DB_DSTDEVP_basic",
            "DSTDEVP(Data!A150:D160,3,Data!A162:B163)",
            "=DSTDEVP(Data!A150:D160,3,Data!A162:B163)",
            "number",
        ),
        case(
            "DB_DVARP_basic",
            "DVARP(Data!A150:D160,3,Data!A162:B163)",
            "=DVARP(Data!A150:D160,3,Data!A162:B163)",
            "number",
        ),
    ]
...
fn static_formula_cases() -> Vec<FormulaCase> {
    vec![
        ...
        case(
            "MDURATION_basic",
            "MDURATION(Data!A234,Data!B234,Data!B233,Data!C233,2)",
            "=MDURATION(Data!A234,Data!B234,Data!B233,Data!C233,2)",
            "number",
        ),
        case(
            "DISC_basic",
            "DISC(Data!A234,Data!B234,990,1000)",
            "=DISC(Data!A234,Data!B234,990,1000)",
            "number",
        ),
        case(
            "INTRATE_basic",
            "INTRATE(Data!A234,Data!B234,990,1000)",
            "=INTRATE(Data!A234,Data!B234,990,1000)",
            "number",
        ),
        case(
            "RECEIVED_basic",
            "RECEIVED(Data!A234,Data!B234,1000,0.05)",
            "=RECEIVED(Data!A234,Data!B234,1000,0.05)",
            "number",
        ),
        case(
        ...
        case(
            "COUPDAYBS_basic",
            "COUPDAYBS(Data!A234,Data!B234,2)",
            "=COUPDAYBS(Data!A234,Data!B234,2)",
            "number",
        ),
        case(
            "COUPDAYS_basic",
            "COUPDAYS(Data!A234,Data!B234,2)",
            "=COUPDAYS(Data!A234,Data!B234,2)",
            "number",
        ),
        case(
            "COUPDAYSNC_basic",
            "COUPDAYSNC(Data!A234,Data!B234,2)",
            "=COUPDAYSNC(Data!A234,Data!B234,2)",
            "number",
        ),
        case(
            "COUPNCD_basic",
            "COUPNCD(Data!A234,Data!B234,2)",
            "=COUPNCD(Data!A234,Data!B234,2)",
            "number",
        ),
        case(
            "COUPNUM_basic",
            "COUPNUM(Data!A234,Data!B234,2)",
            "=COUPNUM(Data!A234,Data!B234,2)",
            "number",
        ),
        case(
            "COUPPCD_basic",
            "COUPPCD(Data!A234,Data!B234,2)",
            "=COUPPCD(Data!A234,Data!B234,2)",
            "number",
        ),
        case(
            "PRICE_basic",
            "PRICE(Data!A234,Data!B234,Data!B233,Data!C233,100,2)",
            "=PRICE(Data!A234,Data!B234,Data!B233,Data!C233,100,2)",
            "number",
        ),
        case(
            "PRICEDISC_basic",
            "PRICEDISC(Data!A234,Data!B234,0.05,100)",
            "=PRICEDISC(Data!A234,Data!B234,0.05,100)",
            "number",
        ),
        case(
            "YIELD_basic",
            "YIELD(Data!A234,Data!B234,Data!B233,99,100,2)",
            "=YIELD(Data!A234,Data!B234,Data!B233,99,100,2)",
            "number",
        ),
        case(
            "YIELDDISC_basic",
            "YIELDDISC(Data!A234,Data!B234,99,100)",
            "=YIELDDISC(Data!A234,Data!B234,99,100)",
            "number",
        ),
        // Info/Reference
