...
fn populate_tests_sheet(wb: &Workbook<'_>) -> Result<(), BridgeError> {
    ...
    let cases = [
        ...
        FormulaCase {
            id: "DEGREES_pi",
            label: "DEGREES(Data!A124)",
            formula: "=DEGREES(Data!A124)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
        ...
        FormulaCase {
            id: "CODE_A",
            label: "CODE(Data!A128)",
            formula: "=CODE(Data!A128)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
        ...
        FormulaCase {
            id: "FIXED_basic",
            label: "FIXED(1234.567,2,FALSE)",
            formula: "=FIXED(1234.567,2,FALSE)",
            expected_type: "string",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "UNICODE_basic",
            label: "UNICODE(Data!A128)",
            formula: "=UNICODE(Data!A128)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
        ...
        FormulaCase {
            id: "TEXTBEFORE_basic",
            label: "TEXTBEFORE(Data!A129,\"@\")",
            formula: "=TEXTBEFORE(Data!A129,\"@\")",
            expected_type: "string",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "TEXTAFTER_basic",
            label: "TEXTAFTER(Data!A129,\"@\")",
            formula: "=TEXTAFTER(Data!A129,\"@\")",
            expected_type: "string",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "LEFT_default",
            label: "LEFT(Data!A126)",
            formula: "=LEFT(Data!A126)",
            expected_type: "string",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
        ...
        FormulaCase {
            id: "SERIESSUM_b",
            label: "SERIESSUM(2,0,1,{1,1,1})",
            formula: "=SERIESSUM(2,0,1,{1,1,1})",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "ROW_basic",
            label: "ROW(Data!A50)",
            formula: "=ROW(Data!A50)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "COLUMN_basic",
            label: "COLUMN(Data!B50)",
            formula: "=COLUMN(Data!B50)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "ROWS_basic",
            label: "ROWS(Data!A1:A10)",
            formula: "=ROWS(Data!A1:A10)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "COLUMNS_basic",
            label: "COLUMNS(Data!A1:L1)",
            formula: "=COLUMNS(Data!A1:L1)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
        ...
        FormulaCase {
            id: "INDIRECT_basic",
            label: "INDIRECT(\"Data!A50\")",
            formula: "=INDIRECT(\"Data!A50\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "FORMULATEXT_b",
            label: "FORMULATEXT(Data!A121)",
            formula: "=FORMULATEXT(Data!A121)",
            expected_type: "string",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "MAXIFS_basic",
            label: "MAXIFS(Data!B138:B142,Data!A138:A142,\"alice\")",
            formula: "=MAXIFS(Data!B138:B142,Data!A138:A142,\"alice\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "MINIFS_basic",
            label: "MINIFS(Data!B138:B142,Data!A138:A142,\"alice\")",
            formula: "=MINIFS(Data!B138:B142,Data!A138:A142,\"alice\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "AVERAGEIFS_basic",
            label: "AVERAGEIFS(Data!B138:B142,Data!A138:A142,\"bob\",Data!C138:C142,\"math\")",
            formula: "=AVERAGEIFS(Data!B138:B142,Data!A138:A142,\"bob\",Data!C138:C142,\"math\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "AVERAGEIFS_multi",
            label: "AVERAGEIFS(Data!B138:B142,Data!A138:A142,\"alice\",Data!C138:C142,\"math\")",
            formula: "=AVERAGEIFS(Data!B138:B142,Data!A138:A142,\"alice\",Data!C138:C142,\"math\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "SUMIFS_multi_cond",
            label: "SUMIFS(Data!B138:B142,Data!A138:A142,\"alice\",Data!C138:C142,\"math\")",
            formula: "=SUMIFS(Data!B138:B142,Data!A138:A142,\"alice\",Data!C138:C142,\"math\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "COUNTIFS_name",
            label: "COUNTIFS(Data!A138:A142,\"alice\")",
            formula: "=COUNTIFS(Data!A138:A142,\"alice\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "COUNTIFS_multi",
            label: "COUNTIFS(Data!A138:A142,\"alice\",Data!C138:C142,\"math\")",
            formula: "=COUNTIFS(Data!A138:A142,\"alice\",Data!C138:C142,\"math\")",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "AGGREGATE_avg",
            label: "AGGREGATE(1,0,Data!A132:A136)",
            formula: "=AGGREGATE(1,0,Data!A132:A136)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "AGGREGATE_skip_err",
            label: "AGGREGATE(1,6,Data!A144:A148)",
            formula: "=AGGREGATE(1,6,Data!A144:A148)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "SUBTOTAL_sum",
            label: "SUBTOTAL(9,Data!A132:A136)",
            formula: "=SUBTOTAL(9,Data!A132:A136)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
        ...
        FormulaCase {
            id: "DATE_year_month",
            label: "YEAR(Data!A112)&\"-\"&MONTH(Data!A112)",
            formula: "=YEAR(Data!A112)&\"-\"&MONTH(Data!A112)",
            expected_type: "string",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "YEARFRAC_basic",
            label: "YEARFRAC(Data!A112,Data!A113)",
            formula: "=YEARFRAC(Data!A112,Data!A113)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "EDATE_neg",
            label: "EDATE(Data!A113,-3)",
            formula: "=EDATE(Data!A113,-3)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "EOMONTH_neg",
            label: "EOMONTH(Data!A113,-1)",
            formula: "=EOMONTH(Data!A113,-1)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "WEEKDAY_mon",
            label: "WEEKDAY(Data!A112,2)",
            formula: "=WEEKDAY(Data!A112,2)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "NETWORKDAYS_INTL",
            label: "NETWORKDAYS.INTL(Data!A112,Data!A113,1)",
            formula: "=NETWORKDAYS.INTL(Data!A112,Data!A113,1)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "AVERAGEA_mixed",
            label: "AVERAGEA(Data!A50,Data!A52,Data!A51,Data!A56)",
            formula: "=AVERAGEA(Data!A50,Data!A52,Data!A51,Data!A56)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "MAXA_mixed",
            label: "MAXA(Data!A50,Data!A52,Data!A51,Data!A56)",
            formula: "=MAXA(Data!A50,Data!A52,Data!A51,Data!A56)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "MINA_mixed",
            label: "MINA(Data!A50,Data!A52,Data!A51,Data!A56)",
            formula: "=MINA(Data!A50,Data!A52,Data!A51,Data!A56)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "CORREL_basic",
            label: "CORREL(Data!A100:A104,Data!A105:A109)",
            formula: "=CORREL(Data!A100:A104,Data!A105:A109)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "INTERCEPT_basic",
            label: "INTERCEPT(Data!A105:A109,Data!A100:A104)",
            formula: "=INTERCEPT(Data!A105:A109,Data!A100:A104)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "SLOPE_basic",
            label: "SLOPE(Data!A105:A109,Data!A100:A104)",
            formula: "=SLOPE(Data!A105:A109,Data!A100:A104)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "FORECAST_basic",
            label: "FORECAST(30,Data!A105:A109,Data!A100:A104)",
            formula: "=FORECAST(30,Data!A105:A109,Data!A100:A104)",
            expected_type: "number",
            kind: FormulaKind::Formula,
        },
        FormulaCase {
            id: "FREQUENCY_sum",
            label: "SUM(FREQUENCY(Data!A100:A109,{20,30,40}))",
            formula: "=SUM(FREQUENCY(Data!A100:A109,{20,30,40}))",
            expected_type: "number",
            kind: FormulaKind::Formula2,
        },
        FormulaCase {
            id: "CONVERT_temp",
            label: "CONVERT(100,\"C\",\"F\")",
