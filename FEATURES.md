...
| Filter (page) fields | R● W● | R✖ W✖ | R✖ W✖ | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_page_fields`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_page_field_multi_select`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_layout_flags`, `duke-sheets-pivot::tests::refresh_renders_page_fields_above_body`, `duke-sheets-pivot::tests::refresh_respects_multiple_page_field_label_visibility`, `duke-sheets-pivot::tests::refresh_wraps_page_fields_down_then_over`, `duke-sheets-pivot::tests::refresh_wraps_page_fields_over_then_down` | §18.10.1 CT_PageField/CT_PivotField | Basic report/page axis plus single-item and multi-item page filters round-trip; page fields render above the pivot body, page-area wrapping refreshes locally, and multiple-item label visibility is respected; advanced page-field UI details are not complete yet |
