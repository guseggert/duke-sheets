...
| Form control: dropdown (combo box) | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::dropdown_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.147 | **XLS**: input range, cell link, selection index, drop-down line count. |
