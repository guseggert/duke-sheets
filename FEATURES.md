...
| Calculated fields | R● W● | R✖ W✖ | R✖ W✖ | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_calculated_fields`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_calculated_items`, `duke-sheets-pivot::tests::refreshes_calculated_field_measure`, `duke-sheets-pivot::tests::refreshes_row_calculated_items`, `duke-sheets-pivot::tests::refreshes_calculated_items_across_column_buckets` | §18.10.1 CT_CacheField, CT_CalculatedItem | Formula-backed cache fields round-trip and refresh as semantic source fields; calculated items round-trip and local refresh supports row/column item formulas over aggregate values; workbook/range references inside pivot formulas and full calculated-item edge cases are not complete yet |
