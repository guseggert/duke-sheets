...
| Sheet protection: password hash | R✔ W✔ | R✔ W✔ | R✔ W✔ | R✖ W✖ | `xlsx_roundtrip::test_roundtrip_protection_settings`, `xlsx_roundtrip::test_roundtrip_sheet_protection_raw_hash`, `sheet_protection_round_trip::protected_sheet_with_password_hash_round_trips`, `sheet_protection_round_trip::protected_sheet_with_raw_password_hash_round_trips`, `xlsb::writer::tests::sheet_protection_roundtrip`, `xlsb::writer::tests::sheet_protection_raw_password_hash_roundtrip` | §18.3.1.79 | Plaintext setter input is hashed to the legacy 16-bit verifier; getter output preserves only the hash |
| Sheet protection: specific permissions (select/format/insert/delete/sort/filter/pivot) | R✔ W✔ | R✔ W✔ | R✖ W✖ | R✖ W✖ | `xlsx_roundtrip::test_roundtrip_protection_settings`, `xlsb::writer::tests::sheet_protection_roundtrip` | §18.3.1.79 | XLSX/XLSB cover the permission flags exposed by `SheetProtection`; XLS currently preserves only the sheet-protected flag and password hash |
...
| Image editAs (move/size with cells) | R✔ W✔ | R✔ W✔ | R✔ W✔ | R✖ W✖ | `xlsx_roundtrip::xlsx_twocell_anchor_editas_round_trips`, `xlsb_drawing_order::xlsb_one_cell_and_absolute_image_anchors_round_trip`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_one_cell_and_absolute_images_we_emit`, `duke-sheets-xls::pictures_round_trip::twocell_anchor_edit_as_collapses_to_default`, `duke-sheets-xls::pictures_round_trip::onecell_anchor_round_trips_with_visual_area_preserved`, `duke-sheets-xls::pictures_round_trip::absolute_anchor_round_trips_with_visual_area_preserved` | §20.4.2.8 | XLSX/XLSB preserve native anchor variants/editAs. XLS stores TwoCell/OneCell/Absolute behavior in ClientAnchor flags 0/2/3. |
...
| Grouped drawing objects | R✔ W● | R✔ W● | R✔ W● | R✖ W✖ | `xlsx_drawing_order::xlsx_group_of_images_round_trips`, `drawing_shapes::xlsx_grouped_shape_child_round_trips`, `xlsb_drawing_order::xlsb_group_of_images_round_trips`, `xls_drawing_order::xls_group_of_images_round_trips_and_keeps_later_shapes_paired` | §20.5.2.17, MS-ODRAW | Nested groups, child coordinate transforms, images/shapes/controls, and z-order round-trip in-process. Dedicated Excel group-survival parity remains to be added. |
