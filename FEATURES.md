...
| Form control: button | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::button_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | §18.3.1.26, MS-XLS §2.4.181 | **XLS**: caption via TXO; macro assignment (ftMacro) is not modeled — skipped on read, never written. Shape names are not persisted (Excel derives them from object ids). |
| Form control: checkbox | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::checkbox_round_trips`, `duke-sheets-xls::form_controls_round_trip::checkbox_mixed_state_round_trips`, `duke-sheets-xls::form_controls_round_trip::cross_sheet_cell_link_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.141 | **XLS**: caption, checked/unchecked/mixed state, cell link (same-sheet PtgRef and cross-sheet PtgRef3d), no-3D flag. `no_3d=false` survives in-process only — Excel rewrites the flag unconditionally on re-save. A linked checkbox's state is driven by the linked cell when Excel loads the file. |
| Form control: option (radio) button | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::option_buttons_round_trip_as_group`, `duke-sheets-xls::form_controls_round_trip::radio_groups_follow_enclosing_group_boxes`, `duke-sheets-xls::form_controls_round_trip::radio_chains_link_within_groups_only`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit`, `excel_com_e2e::writing_xls::excel_can_read_radio_groups_we_emit` | MS-XLS §2.5.153 | **XLS**: caption, state, cell link. Radios group by their innermost enclosing group box (center-point containment), radios outside every box form the sheet group; the writer chains each group circularly in insertion order with fFirstBtn on the head, matching Excel's persistence. Containment is evaluated at default cell metrics, so custom row/column sizes that visually shift a radio across a box edge are not accounted for. |
| Form control: label | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::label_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.4.181 | - |
| Form control: group box | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::group_box_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.145 | - |
| Form control: list box | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::list_box_round_trips`, `duke-sheets-xls::form_controls_round_trip::list_box_multi_select_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.147 | **XLS**: input range, cell link, single/multi/extend selection with one-based selected indices (bsels). Explicit item lists (rgLines) are dialog-sheet-only and not modeled; items come from the input range. |
| Form control: dropdown (combo box) | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::dropdown_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.147 | **XLS**: input range, cell link, selection index, drop-down line count. Excel's auxiliary UI dropdowns (one hidden ot=0x14 OBJ per autofilter column, plus pivot/table-total variants) are filtered out on read via ftCmo.fUIObj and the ftLbsData lct behavior class — pinned by `duke-sheets-xls reader::tests::autofilter_dropdown_obj_is_not_a_form_control`. |
| Form control: scrollbar | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::scrollbar_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.154 | **XLS**: value/min/max/increment/page, horizontal or vertical orientation, cell link. |
| Form control: spinner | R✖ W✖ | R✖ W✖ | R✔ W✔ | R✖ W✖ | `duke-sheets-xls::form_controls_round_trip::spinner_round_trips`, `excel_com_e2e::writing_xls::excel_can_read_form_controls_we_emit` | MS-XLS §2.5.154 | **XLS**: value/min/max/increment, cell link. |
