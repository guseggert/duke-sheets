...
| Row / column / value fields | R● W● | R✖ W✖ | R✖ W✖ | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_emits_pivot_table_and_cache_parts`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_source_pivot`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_field_sort`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_axis_field_options`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_subtotal_functions`, `duke-sheets-pivot::tests::refreshes_row_field_subtotals`, `duke-sheets-pivot::tests::refreshes_outline_layout_subtotals_at_top`, `duke-sheets-pivot::tests::refresh_inserts_blank_rows_after_row_field_items`, `duke-sheets-pivot::tests::refresh_inserts_leaf_field_blank_rows_before_parent_subtotals`, `duke-sheets-pivot::tests::refresh_inserts_page_breaks_after_row_field_items`, `duke-sheets-pivot::tests::refreshes_column_field_subtotals`, `duke-sheets-pivot::tests::refreshes_outline_layout_column_subtotals_at_top`, `duke-sheets-pivot::tests::refreshes_custom_row_subtotal_function`, `duke-sheets-pivot::tests::refreshes_multiple_row_subtotal_functions`, `duke-sheets-pivot::tests::refreshes_multiple_column_subtotal_functions`, `duke-sheets-pivot::tests::refreshes_custom_column_subtotal_function`, `duke-sheets-pivot::tests::refreshes_show_empty_items_on_row_fields`, `duke-sheets-pivot::tests::refreshes_show_empty_items_on_column_fields`, `duke-sheets-pivot::tests::refresh_includes_new_items_in_existing_filters`, `excel_com_e2e::writing::test_write_basic_pivot_survives_excel_roundtrip` | §18.10.1 CT_PivotField@sortType/showAll/subtotal flags | Basic row, column, and data fields with manual/ascending/descending item sort, show-empty-items, dropdown visibility, subtotal placement, include-new-items, and item-page-count options round-trip; multiple subtotal flags round-trip, show-empty-items, include-new-items field filters, row blank-row insertion, row page-break insertion, row-/column-axis subtotal refresh with custom subtotal functions, and outline row/column subtotal-top placement are supported; local refresh emits multiple subtotal functions for row and column fields; hierarchies and OLAP fields are not supported yet |
