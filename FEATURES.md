...
| Feature | XLSX | XLSB | XLS | ODS | Test | Spec |
|---------|------|------|-----|-----|------|------|
| Pivot cache (source data) | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_emits_pivot_table_and_cache_parts`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_source_pivot`, `duke-sheets-xlsx::writer::tests::test_writer_separates_pivot_caches_for_refresh_policy`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_external_pivot_source_definition`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_external_pivot_database_connection`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_olap_pivot_source_definition`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_scenario_pivot_source_definition`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_consolidation_pivot_source_ranges`, `duke-sheets-pivot::tests::refreshes_consolidation_source_ranges`, `duke-sheets-pivot::tests::shared_consolidation_sources_hit_the_internal_snapshot_cache`, `excel_com_e2e::writing::test_write_basic_pivot_survives_excel_roundtrip`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_native_parts`, `duke-sheets-xlsb::reader::tests::reads_writer_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_native_biff8_streams`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_multi_measure_values_axis_semantics`, `excel_com_e2e::writing_xls::excel_opens_xls_with_native_pivot_table`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_column_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_column_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_page_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_page_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_multi_measure_values_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_multi_measure_values_axis`, `excel_com_e2e::writing_xlsb::excel_opens_xlsb_with_native_pivot_table`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_column_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_column_axis`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_page_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_page_axis`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_multi_measure_values_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_multi_measure_values_axis` | §18.10.1 CT_PivotCacheDefinition/CT_CacheSource/CT_Consolidation, MS-XLSB BrtBeginPCD/BrtPCDRecord, MS-XLS SXDB/SXIDSTM/DCONREF | Worksheet/table source cache definitions, generated cache records, cache-affecting refresh policy partitioning, non-refreshable external/scenario/OLAP cache-source metadata, and external database command metadata through workbook connections are writable; scenario names, database connection credentials/parameters/ODC metadata, consolidation ranges, range names, and page labels round-trip, and worksheet/table/consolidation sources refresh locally with private snapshot caching. Full OLAP/data-model cache writing is not complete yet; XLSB read/write covers worksheet-range source caches for row, column, page, and multiple data fields, including explicit Values-axis placement; reading preserves source ranges, source fields, shared items needed for selected page fields, record counts, and read-only cache diagnostics, while writing emits saved cache records and is verified by Excel COM parity; XLS read/write covers worksheet-range source caches for a single row field, optional single column field, optional single selected page field, and multiple aggregate data fields in verified layouts; reading preserves source ranges, source fields, selected page shared items, record counts, and read-only cache diagnostics; XLSB cache-record/table/external/consolidation/OLAP reading, XLS table/external/consolidation/OLAP cache reading, broader legacy pivot variants, and advanced cache options remain incomplete. |
| Pivot table definition | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_emits_pivot_table_and_cache_parts`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_source_pivot`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_layout_flags`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_axis_field_options`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_refresh_policy`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_advanced_filters`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_table_extensions`, `duke-sheets-xlsx::reader::pivot::tests::date_pivot_filter_types_are_parsed`, `duke-sheets-xlsx::reader::pivot::tests::range_pivot_filter_types_are_parsed`, `duke-sheets-xlsx::reader::pivot::tests::unsupported_pivot_filter_types_are_preserved`, `duke-sheets-pivot::tests::refresh_applies_date_filters`, `duke-sheets-pivot::tests::refresh_applies_range_filters`, `duke-sheets-pivot::tests::relative_date_period_filters_require_today`, `duke-sheets-pivot::tests::refresh_applies_grand_total_caption`, `duke-sheets-pivot::tests::refresh_applies_total_asterisk_captions`, `duke-sheets-pivot::tests::refresh_applies_missing_value_caption`, `duke-sheets-pivot::tests::refresh_applies_error_caption_to_axis_labels`, `duke-sheets-pivot::tests::refresh_respects_hidden_field_headers`, `duke-sheets-pivot::tests::refresh_writes_row_outline_levels_for_outline_layout`, `duke-sheets-pivot::tests::refresh_clears_stale_pivot_row_outline_levels`, `duke-sheets-pivot::tests::refresh_writes_row_collapsed_flags_for_collapsed_items`, `duke-sheets-pivot::tests::refresh_writes_column_outline_levels_for_column_hierarchy`, `duke-sheets-pivot::tests::refresh_clears_stale_pivot_column_outline_levels`, `duke-sheets-pivot::tests::refresh_writes_column_collapsed_flags_for_collapsed_items`, `duke-sheets-pivot::tests::refreshes_compact_layout_hierarchy_without_column_fields`, `duke-sheets-pivot::tests::refreshes_compact_layout_hierarchy_with_column_fields`, `duke-sheets-pivot::tests::refreshes_tabular_layout_without_repeated_item_labels`, `duke-sheets-pivot::tests::refreshes_tabular_layout_with_repeated_item_labels`, `duke-sheets-pivot::tests::refresh_merges_and_clears_tabular_item_labels`, `duke-sheets-pivot::tests::refreshes_layout_show_empty_rows`, `duke-sheets-pivot::tests::refreshes_layout_show_empty_columns`, `duke-sheets-pivot::tests::refreshes_values_axis_on_rows`, `duke-sheets-pivot::tests::refresh_applies_non_visual_totals`, `duke-sheets-pivot::tests::refresh_includes_hidden_items_in_subtotals`, `duke-sheets-pivot::tests::external_sources_are_marked_external_without_failing_refresh`, `duke-sheets-pivot::tests::external_sources_do_not_block_local_pivot_refresh`, `excel_com_e2e::writing::test_write_basic_pivot_survives_excel_roundtrip`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_native_parts`, `duke-sheets-xlsb::reader::tests::reads_writer_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_native_biff8_streams`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_multi_measure_values_axis_semantics`, `excel_com_e2e::writing_xls::excel_opens_xls_with_native_pivot_table`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_column_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_column_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_page_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_page_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_multi_measure_values_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_multi_measure_values_axis`, `excel_com_e2e::writing_xlsb::excel_opens_xlsb_with_native_pivot_table`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_column_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_column_axis`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_page_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_page_axis`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_multi_measure_values_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_multi_measure_values_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_average_data_field`, `excel_com_e2e::writing_xls::excel_preserves_xls_average_pivot_data_field` | §18.10.1 CT_PivotTableDefinition/CT_PivotCacheDefinition, MS-XLSB BrtBeginSXView, MS-XLS SXVIEW/SXVD/SXVI/SXLI | Basic semantic definitions round-trip: source, location, layout/grand-total/header/expand-collapse/print-title/page-area/merge-label/caption/error-missing-display/data-axis flags, interaction/drop-zone/data-tip/empty-row-column display flags, refresh policy, fields, measures, style, item/label/value/date comparison/date range/date period/label range/value range/top-N filters, and table-level extension payload preservation; compact row hierarchy, outline row/column metadata, hidden field headers, collapsed member metadata, collapsed row/column outline refresh with hidden detail rows/columns, custom error, grand-total, missing-value, and asterisk-total captions, and tabular/outline repeat-item-label, merged item-label, empty row/column, values-axis-on-rows, non-visual total, and hidden-item subtotal refresh are supported; relative date-period refresh requires an explicit `today` serial in refresh options; external-source pivots are marked externally managed during local refresh; advanced extension semantics and style UI details are not complete yet; XLSB read/write covers basic worksheet-range pivot tables with row fields, a single column field, simple page fields, multiple data fields with explicit Values-axis placement, native cache/table parts, and Excel COM open/re-save parity; XLSB reading preserves source, target, rendered range, data caption, style name, page selections, and cache diagnostics for this slice; XLS read/write covers one row field plus aggregate data fields, a separately verified single column-field Sum layout, a separately verified selected page-field Sum layout, and multi-field Values-on-columns layouts; reading preserves source, target, rendered range, page selections, Values-axis placement, and cache diagnostics for this slice; XLSB advanced filters/extensions/layout semantics, broader XLS legacy pivot variants, XLS advanced filters, extensions, and advanced layout semantics remain incomplete. |
| Row / column / value fields | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_emits_pivot_table_and_cache_parts`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_source_pivot`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_field_sort`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_axis_field_options`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_subtotal_functions`, `duke-sheets-pivot::tests::refreshes_row_field_subtotals`, `duke-sheets-pivot::tests::refreshes_outline_layout_subtotals_at_top`, `duke-sheets-pivot::tests::refresh_applies_axis_field_captions`, `duke-sheets-pivot::tests::refresh_applies_axis_subtotal_caption`, `duke-sheets-pivot::tests::refresh_inserts_blank_rows_after_row_field_items`, `duke-sheets-pivot::tests::refresh_inserts_leaf_field_blank_rows_before_parent_subtotals`, `duke-sheets-pivot::tests::refresh_inserts_page_breaks_after_row_field_items`, `duke-sheets-pivot::tests::refreshes_column_field_subtotals`, `duke-sheets-pivot::tests::refreshes_outline_layout_column_subtotals_at_top`, `duke-sheets-pivot::tests::refreshes_custom_row_subtotal_function`, `duke-sheets-pivot::tests::refreshes_multiple_row_subtotal_functions`, `duke-sheets-pivot::tests::refreshes_multiple_column_subtotal_functions`, `duke-sheets-pivot::tests::refreshes_custom_column_subtotal_function`, `duke-sheets-pivot::tests::refreshes_show_empty_items_on_row_fields`, `duke-sheets-pivot::tests::refreshes_show_empty_items_on_column_fields`, `duke-sheets-pivot::tests::refresh_includes_new_items_in_existing_filters`, `excel_com_e2e::writing::test_write_basic_pivot_survives_excel_roundtrip`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_native_parts`, `duke-sheets-xlsb::reader::tests::reads_writer_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_native_biff8_streams`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_multi_measure_values_axis_semantics`, `excel_com_e2e::writing_xls::excel_opens_xls_with_native_pivot_table`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_column_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_column_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_multi_measure_values_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_multi_measure_values_axis`, `excel_com_e2e::writing_xlsb::excel_opens_xlsb_with_native_pivot_table`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_column_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_column_axis`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_multi_measure_values_axis_records`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_multi_measure_values_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_average_data_field`, `excel_com_e2e::writing_xls::excel_preserves_xls_average_pivot_data_field` | §18.10.1 CT_PivotField@name/sortType/showAll/subtotal flags/subtotalCaption, MS-XLSB SXVD/SXVI/SXLI equivalents, MS-XLS SXVD/SXVI/SXLI/SXDI | Basic row, column, and data fields with manual/ascending/descending item sort, field captions, show-empty-items, dropdown visibility, subtotal placement, field subtotal captions, include-new-items, and item-page-count options round-trip; multiple subtotal flags round-trip, show-empty-items, include-new-items field filters, row blank-row insertion, row page-break insertion, row-/column-axis subtotal refresh with custom subtotal functions, field captions, and subtotal captions, and outline row/column subtotal-top placement are supported; local refresh emits multiple subtotal functions for row and column fields; hierarchies and OLAP fields are not supported yet; XLSB read/write covers one row field, one column field, and multiple data/value fields with explicit Values-axis placement; XLS read/write covers one row field, one separately verified column field, and multiple aggregate data/value fields with explicit Values-axis placement for verified layouts; XLSB/XLS subtotals, sorting options, OLAP hierarchies, and broader legacy pivot variants remain incomplete. |
| Filter (page) fields | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_page_fields`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_page_field_multi_select`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_layout_flags`, `duke-sheets-pivot::tests::refresh_renders_page_fields_above_body`, `duke-sheets-pivot::tests::refresh_respects_multiple_page_field_label_visibility`, `duke-sheets-pivot::tests::refresh_applies_label_filter_to_page_field_caption`, `duke-sheets-pivot::tests::refresh_applies_error_caption_to_page_field_label`, `duke-sheets-pivot::tests::refresh_wraps_page_fields_down_then_over`, `duke-sheets-pivot::tests::refresh_wraps_page_fields_over_then_down`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_page_axis_records`, `duke-sheets-xlsb::reader::tests::reads_writer_pivot_table_semantics`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_page_axis`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_page_axis_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_pivot_table_semantics`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_page_axis` | §18.10.1 CT_PageField/CT_PivotField, MS-XLSB BrtBeginSXPIs/BrtBeginSXPI, MS-XLS SXPI | Basic report/page axis plus single-item and multi-item page filters round-trip; page fields render above the pivot body, page-area wrapping refreshes locally, multiple-item label visibility is respected, selected page-field captions reflect item and label filters, and error captions apply to selected page-field items; XLSB read/write covers simple worksheet-range page fields with all-items or one selected item and Excel COM parity; XLS read/write covers a single selected worksheet-range page field with Excel COM parity; XLSB/XLS multi-item page filter state, advanced page-field UI details, broader legacy pivot variants, and ODS page-field writing are not complete yet |
| Aggregate functions (Sum/Count/Avg/...) | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_emits_pivot_table_and_cache_parts`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_source_pivot`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_show_as_percentages`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_show_as_base_field`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_rank_show_as`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_parent_show_as`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_index_show_as`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_measure_number_format`, `duke-sheets-pivot::tests::refreshes_parent_percentage_show_as_calculations`, `duke-sheets-pivot::tests::refresh_applies_measure_number_format`, `excel_com_e2e::writing::test_write_basic_pivot_survives_excel_roundtrip`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_native_parts`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_native_biff8_streams`, `excel_com_e2e::writing_xls::excel_opens_xls_with_native_pivot_table`, `excel_com_e2e::writing_xlsb::excel_opens_xlsb_with_native_pivot_table`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_multi_measure_values_axis_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_all_aggregate_data_field_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_all_aggregate_data_fields`, `duke-sheets-xlsb::reader::tests::reads_writer_pivot_table_semantics`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_multi_measure_values_axis`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_all_aggregate_data_fields`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_average_data_field`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_pivot_table_semantics`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_multi_measure_values_axis_semantics`, `excel_com_e2e::writing_xls::excel_preserves_xls_average_pivot_data_field`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_all_aggregate_data_field_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_all_aggregate_data_field_semantics`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_all_aggregate_pivot_workbook`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_all_aggregate_data_fields`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_multi_measure_values_axis_records`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_multi_measure_values_axis` | §18.10.1 dataField@showDataAs/dataField@numFmtId, [MS-XLSX] x14 data field extension, MS-XLSB BrtBeginSXDI/DataConsolidationFunction, MS-XLS SXDI | Data-field subtotal functions, percent-of-row/column/grand-total/index, ECMA base-field difference/percent-difference/running-total, x14 rank and parent percentage show-as calculations, and measure number-format round-trip plus semantic refresh; XLSB read/write covers all basic DataConsolidationFunction aggregate codes (Sum, Count, CountNumbers, Average, Max, Min, Product, StdDev, StdDevP, Var, VarP) in native multi-measure pivot records with explicit Values-axis placement and Excel COM parity; XLSB BrtBeginSXDI uses the spec iiftab field for aggregation and preserves display captions; XLS read/write covers all BIFF8 SXDI aggregate codes in native pivot records with LO openability and Excel COM parity; remaining show-as variants remain incomplete for XLSB/XLS read/write. |
| Pivot table styles | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_emits_pivot_table_and_cache_parts`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_source_pivot`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_style_flags`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_style_record`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_style`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_style_record`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_pivot_style_semantics` | §18.10.1 CT_PivotTableStyle, MS-XLSB BrtSXViewStyle, MS-XLS FRT 0x0864 style metadata | Basic `pivotTableStyleInfo` name/header/stripe/last-column flags round-trip; XLSB/XLS read/write preserves the native style name plus row-header, column-header, row-stripe, column-stripe, and last-column flags for supported worksheet-range pivots; detailed rendered style formatting, custom style definitions, style extensions, and broader legacy pivot variants remain incomplete. |
| Calculated fields | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_calculated_fields`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_table_qualified_pivot_calculated_fields`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_escaped_table_qualified_pivot_calculated_fields`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_calculated_items`, `duke-sheets-pivot::tests::refreshes_calculated_field_measure`, `duke-sheets-pivot::tests::refreshes_calculated_field_workbook_range_references`, `duke-sheets-pivot::tests::refreshes_sequential_calculated_fields_with_structured_refs`, `duke-sheets-pivot::tests::refreshes_table_qualified_calculated_fields_with_structured_refs`, `duke-sheets-pivot::tests::refreshes_table_qualified_calculated_fields_with_escaped_structured_refs`, `duke-sheets-pivot::tests::refreshes_row_calculated_items`, `duke-sheets-pivot::tests::refreshes_calculated_items_across_column_buckets`, `duke-sheets-pivot::tests::refreshes_column_calculated_items_with_cell_like_item_names`, `duke-sheets-pivot::tests::refreshes_dependent_calculated_items_out_of_order`, `duke-sheets-pivot::tests::refresh_rejects_circular_calculated_items`, `duke-sheets-pivot::tests::refresh_rejects_cell_like_calculated_item_self_reference`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_calculated_field_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_calculated_field`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_calculated_field_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_calculated_field_semantics` | §18.10.1 CT_CacheField, CT_CalculatedItem; MS-XLSB BrtBeginPCDField/PivotParsedFormula/BrtBeginPNames/BrtBeginPName/PtgSxName; MS-XLS SXFDB/SxFmla/SxName/PtgSxName | Formula-backed cache fields round-trip and refresh as semantic source fields, including workbook cell/range references and unqualified or matching table-qualified structured field references with escaped current-row column names; XLSB read/write preserves basic calculated fields through BrtBeginPCDField formulas plus PName/PtgSxName source-field references; XLS read/write preserves basic BIFF8 calculated fields through SXFDB, SxFmla, SxName, and PtgSxName; XLSB/XLS calculated-field formulas currently cover source-field references, literals, and arithmetic/comparison/string operators; XLSB/XLS calculated items, broader calculated-field formula grammar, and remaining calculated-item edge cases are not complete yet |
| Grouping (dates, numbers, items) | R● W● | R● W● | R● W● | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_pivot_grouping`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_multi_unit_date_grouping`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_manual_pivot_grouping`, `duke-sheets-pivot::tests::refreshes_single_unit_date_grouping`, `duke-sheets-pivot::tests::refreshes_multi_unit_date_grouping_hierarchy`, `duke-sheets-pivot::tests::refreshes_manual_item_grouping`, `duke-sheets-xlsx::pivot_compat::lo_can_open_manual_grouped_pivot`, `excel_com_e2e::writing::test_write_manual_pivot_grouping_survives_excel_roundtrip`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_numeric_grouping_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_numeric_grouping`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_numeric_grouping`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_date_grouping_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_date_grouping`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_date_grouping`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_multi_unit_date_grouping_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_multi_unit_date_grouping`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_multi_unit_date_grouping`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_emit_xlsb_manual_grouping_records`, `duke-sheets-xlsb::writer::tests::semantic_pivot_tables_round_trip_xlsb_manual_grouping`, `excel_com_e2e::writing_xlsb::excel_preserves_xlsb_pivot_manual_grouping`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_numeric_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_numeric_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_numeric_grouped_pivot_workbook`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_numeric_grouping`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_date_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_date_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_date_grouped_pivot_workbook`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_date_grouping`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_multi_unit_date_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_multi_unit_date_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_multi_unit_date_grouped_pivot_workbook`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_multi_unit_date_grouping`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_manual_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_manual_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_numeric_manual_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_numeric_manual_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_manual_column_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_manual_column_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_manual_page_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_manual_page_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::semantic_pivot_tables_emit_xls_bool_error_manual_grouping_records`, `duke-sheets-xls::skeleton_round_trip::reads_writer_xls_bool_error_manual_grouping_semantics`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_manual_grouped_pivot_workbook`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_numeric_manual_grouped_pivot_workbook`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_bool_error_manual_grouped_pivot_workbook`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_manual_column_grouped_pivot_workbook`, `duke-sheets-xls::skeleton_round_trip::lo_can_open_manual_page_grouped_pivot_workbook`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_manual_grouping`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_numeric_manual_grouping`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_bool_error_manual_grouping`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_manual_column_grouping`, `excel_com_e2e::writing_xls::excel_preserves_xls_pivot_manual_page_grouping` | §18.10.1 CT_FieldGroup/CT_RangePr/CT_DiscretePr/CT_GroupItems; MS-XLSB BrtBeginPCDFGroup/BrtBeginPCDFGRange/BrtBeginPCDFGDiscrete/BrtBeginPCDFGItems; MS-XLS SXFDB/SXRng/SXNum/SXBool/SXErr/SXDtr/SXInt/SXIDSTM | Basic numeric `rangePr` bins, single-unit date grouping, multi-unit date grouped-field hierarchies, and manual item `groupItems` round-trip with Excel SaveAs parity for supported XLSX/XLSB/XLS grouping variants; XLSB read/write currently preserves basic numeric range grouping, single-unit and multi-unit date grouping, and manual item grouping through BrtBeginPCDFGroup/BrtBeginPCDFGRange/BrtBeginPCDFGDiscrete/BrtBeginPCDFGItems for worksheet-range pivots with Excel SaveAs parity; XLS read/write currently preserves basic numeric range grouping, single-unit and multi-unit date grouping, row-/column-axis text manual item grouping, row-axis numeric and boolean/error manual item grouping, and page-axis text manual item grouping through SXFDB/SXRng/SXNum/SXBool/SXErr/SXDtr/SXInt/SXIDSTM for worksheet-range pivots with LO openability and Excel SaveAs parity; semantic refresh supports multi-unit date hierarchies and manual item groups; advanced grouping UI hierarchy details are not complete yet |
| Slicers | R● W● | R✖ W✖ | R- W- | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_workbook_extension_parts` | [MS-XLSX] §2.3.16 | XLSX workbook extension refs and slicer cache package parts preserve/round-trip as raw workbook extension parts; semantic slicer objects, UI placement, selection state editing, and pivot/filter integration are not modeled yet |
| Timelines | R● W● | R✖ W✖ | R- W- | R✖ W✖ | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_workbook_extension_parts` | [MS-XLSX] §2.3.20 | XLSX workbook extension refs and timeline cache package parts preserve/round-trip as raw workbook extension parts; semantic timeline objects, UI placement, selection state editing, and pivot/filter integration are not modeled yet |
| PivotChart | R● W● | R✖ W✖ | R✖ W✖ | R✖ W✖ | `duke-sheets-xlsx::writer::chart::tests::test_pivot_source_roundtrip`, `duke-sheets-core::worksheet::tests::test_build_pivot_chart_from_rendered_range` | §21.3 CT_PivotSource | Basic chart-level `c:pivotSource` name/fmtId round-trips; PivotChart helpers generate chart series from refreshed/imported pivot rendered ranges; pivot formats, slicer/timeline chart state, and Excel UI parity are not complete yet |
...
| Data connections (basic) | R● W● | R✖ W✖ | R- W- | R- W- | `duke-sheets-xlsx::writer::tests::test_writer_round_trips_external_pivot_database_connection`, `duke-sheets-xlsx::writer::tests::test_writer_round_trips_basic_non_database_connections` | §18.13 CT_Connections/CT_Connection/CT_DbPr/CT_OlapPr/CT_WebPr/CT_TextPr/CT_Parameters | Basic workbook `connections.xml` database, web, text, and OLAP connections with id/name, source/ODC file metadata, refresh flags, credentials, query parameters, and core payload attributes round-trip; OLE DB/model extension details and live refresh are not complete yet |
