...
7. ~~**XLS conditional-format E2E regressions**~~ — Fixed. XLS reader now accepts LibreOffice's `ct=0` CellIs CF records, so `test_xls_cf_cell_is_greater_than` and `test_xls_cf_multiple_rules` pass again.
