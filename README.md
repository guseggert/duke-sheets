...
> Last updated: 2026-03-06 &middot; commit [`493b94b`](../../commit/493b94b)
>
...
| xlsx_read/100_cells | — | duke-sheets | 199 µs |
| xlsx_read/100_cells | — | umya-spreadsheet | 333.5 µs |
| xlsx_read/10k_cells | — | calamine | 6.297 ms |
| xlsx_read/10k_cells | — | duke-sheets | 10.84 ms |
| xlsx_read/10k_cells | — | umya-spreadsheet | 14.79 ms |
| xlsx_read/1k_cells | — | calamine | 678.2 µs |
| xlsx_read/1k_cells | — | duke-sheets | 1.186 ms |
| xlsx_read/1k_cells | — | umya-spreadsheet | 1.677 ms |
| xlsx_write_serialize/100_cells | — | duke-sheets | 376.3 µs |
| xlsx_write_serialize/100_cells | — | umya-spreadsheet | 456.5 µs |
| xlsx_write_serialize/10k_cells | — | duke-sheets | 18.83 ms |
| xlsx_write_serialize/10k_cells | — | umya-spreadsheet | 17.52 ms |
| xlsx_write_serialize/1k_cells | — | duke-sheets | 1.851 ms |
| xlsx_write_serialize/1k_cells | — | umya-spreadsheet | 1.88 ms |
| xlsx_write_full/100_cells | — | duke-sheets | 395.8 µs |
| xlsx_write_full/100_cells | — | rust_xlsxwriter | 452.6 µs |
| xlsx_write_full/100_cells | — | umya-spreadsheet | 580.3 µs |
| xlsx_write_full/10k_cells | — | duke-sheets | 20.13 ms |
| xlsx_write_full/10k_cells | — | rust_xlsxwriter | 13.89 ms |
| xlsx_write_full/10k_cells | — | umya-spreadsheet | 23.39 ms |
| xlsx_write_full/1k_cells | — | duke-sheets | 1.992 ms |
| xlsx_write_full/1k_cells | — | rust_xlsxwriter | 1.524 ms |
| xlsx_write_full/1k_cells | — | umya-spreadsheet | 2.476 ms |
| csv_read/100_cells | — | duke-sheets | 30.1 µs |
| csv_read/10k_cells | — | duke-sheets | 1.597 ms |
| csv_read/1k_cells | — | duke-sheets | 161.9 µs |
| csv_write/100_cells | — | duke-sheets | 10.37 µs |
| csv_write/10k_cells | — | duke-sheets | 1.336 ms |
| csv_write/1k_cells | — | duke-sheets | 121.1 µs |
| formula_parse/complex | — | — | 13.69 µs |
| formula_parse/medium | — | — | 6.916 µs |
| formula_parse/simple | — | — | 1.948 µs |
| formula_parse/throughput_1000 | — | — | 727.8 µs |
| calculation/linear_chain | 100 | — | 1.268 ms |
| calculation/linear_chain | 500 | — | 29.72 ms |
| calculation/linear_chain | 1000 | — | 120.1 ms |
| calculation/fan_out | 26 | — | 169.6 µs |
| calculation/fan_out | 52 | — | 584.2 µs |
| calculation/fan_out | 100 | — | 1.984 ms |
| calculation/fan_out | 200 | — | 7.439 ms |
| calculation/cross_sheet | 100 | — | 262.4 µs |
| calculation/cross_sheet | 500 | — | 1.369 ms |
| calculation/cross_sheet | 1000 | — | 2.797 ms |
| calculation/cross_sheet | 5000 | — | 15.36 ms |
| calculation/mixed | 100 | — | 462.9 µs |
| calculation/mixed | 500 | — | 2.34 ms |
| calculation/mixed | 1000 | — | 4.694 ms |
<!-- BENCHMARKS:END -->
