...
impl From<&duke_sheets::DrawingAnchor> for PyDrawingAnchor {
    fn from(a: &duke_sheets::DrawingAnchor) -> Self {
        match a {
            ...
            _ => {
                let node = super_anchor_to_two_cell(a);
                Self::from(&node)
            }
        }
    }
...
fn super_anchor_to_two_cell(anchor: &duke_sheets::DrawingAnchor) -> duke_sheets::DrawingAnchor {
